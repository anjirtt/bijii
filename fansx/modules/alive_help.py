...
<blockquote>{bot.me.mention}
    status: {status} 
       {psr} expired_on: {exp} 
        ...
        <blockquote><b>Userbot 5k/bulan by @Ubotpirzyjembod_bot</b></blockquote>
"""
...
async def user_help_inline(client, inline_query):
    ...
    msg = f"<blockquote><b>𖥂 Menu Inline <a href=tg://user?id={inline_query.from_user.id}>{inline_query.from_user.first_name} {inline_query.from_user.last_name or ''}</a>\n𖥂 Total module : {len(HELP_COMMANDS)}\n𖥂 Prefixs : {' '.join(SH)}\n𖥂 My ubot : <a href=t.me/Ubotpirzyjembod_bot>Pirzy-userbot</a></b></blockquote>"
...
async def help_callback(client, callback_query):
    ...
    top_text = f"<blockquote><b>𖥂 Menu Inline : <a href=tg://user?id={callback_query.from_user.id}>{callback_query.from_user.first_name} {callback_query.from_user.last_name or ''}</a>\n𖥂 Total module : {len(HELP_COMMANDS)}\n𖥂 Prefixs : {' '.join(SH)}\n𖥂 My ubot : <a href=t.me/Ubotpirzyjembod_bot>Pirzy-userbot</a></b></blockquote>"
