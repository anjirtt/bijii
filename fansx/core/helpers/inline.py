...
class BTN:
    ...
    def PROMODEK(message):
        button = [
            [InlineKeyboardButton("「 ✅ Setuju & Lanjutkan 」", url="http://t.me/zenith_239?text=Bang+Mau+Beli+Reseller+Ubot+Kirim+Qris+Atau+Dana")],
        ]
        return button

    def ALWAYSBOYSZ(message):
        button = [
            [InlineKeyboardButton("room public", url="https://t.me/+L4qhnsKNpPozZGZl")],
        ]
        return button
    ...
    def START(message):
        if not message.from_user.id == OWNER_ID:
            button = [
                ...
                [
                    InlineKeyboardButton("✭ ʀᴏᴏᴍ ᴘᴜʙʟɪᴄ ✭", url="https://t.me/+L4qhnsKNpPozZGZl"),
                    InlineKeyboardButton("⦪ owner ✭", url="https://t.me/zenith_239")
                ],
                [
                    InlineKeyboardButton("⦪ ᴀʙᴏᴜᴛ dhekz ✭", url="https://t.me/bijitesti")
                ],
                [
